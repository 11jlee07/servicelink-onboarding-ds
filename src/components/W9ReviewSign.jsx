    ...
    <>
      <div className="max-w-3xl mx-auto px-4 py-6 sm:py-8">
        <div className="bg-white rounded-exos shadow-sm border border-slate-100 p-6">
          ...
          {/* Certification */}
          <div className="mb-5 sm:mb-6 p-4 bg-slate-50 border border-slate-200 rounded-exos-sm ">
            ...
            {showCertInfo && (
              <div className="mt-3 p-3 bg-white border border-slate-200 rounded-exos text-sm text-slate-600">
          ...
          <div className="mb-6">
            ...
            {signatureDataUrl && (
              <div className="border-2 border-blue-400 rounded-exos overflow-hidden bg-white mb-3">
                <img
      ...
      {showSignModal && (
        <div style={{ position: 'fixed', inset: '32px', zIndex: 50 }}
          className="bg-white rounded-exos shadow-2xl flex flex-col overflow-hidden">
          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-slate-100 flex-shrink-0">
            ...
            <button type="button" onClick={() => setShowSignModal(false)}
              className="p-2 rounded-exos text-slate-400 hover:text-slate-600 hover:bg-slate-100 transition-colors">
              <X className="w-5 h-5" />
            </button>
          </div>
          ...
          <div className="flex-1 p-3 sm:p-5" style={{ minHeight: 0 }}>
            <div className="relative w-full h-full rounded-exos overflow-hidden border-2 border-slate-200">
              <canvas
                ref={canvasRef}
                width={2000}
                height={800}
